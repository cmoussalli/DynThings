...
namespace DynThings.Data.Reports
{
    public class ThingsReport
    {
        ...
        //public Chart IOs_Monthly(long ThingID,string year)
        //{
        ...
        //    List<Rpt_Thing_IOs_Months_Result> rpt = db.Rpt_Thing_IOs_Months(ThingID,year).ToList();

        //    #region GetMin
        //    Serie s1 = new Serie();
        //    s1.Name = "Min";
        //    Rpt_Thing_IOs_Months_Result rpt1 = rpt[0];
        ...
        //    Serie s2 = new Serie();
        //    s2.Name = "Max";
        //    Rpt_Thing_IOs_Months_Result rpt2 = rpt[1];
        ...
        //    Serie s3 = new Serie();
        //    s3.Name = "Avg";
        //    Rpt_Thing_IOs_Months_Result rpt3 = rpt[2];
        ...
        //public Chart IOs_Daily(long ThingID)
        //{
        //    Thing ep = UnitOfWork_Repositories.repoThings.Find(ThingID);

        //    Chart hc = new Chart();
        //    hc.title.Text = "Thing Daily Report";
        //    hc.subTitle.Text = ep.Title;
        //    hc.xAxis.GenerateDaysList(true);
        //    hc.legend.layout = Layout.vertical.ToString();

        //    List<Rpt_Thing_IOs_Days_Result> rpt = db.Rpt_Thing_IOs_Days(ThingID).ToList();

        //    #region GetMin
        //    Serie s1 = new Serie();
        //    s1.Name = "Min";
        //    Rpt_Thing_IOs_Days_Result rpt1 = rpt[0];
        //    List<int> resultMin = new List<int>();
        //    resultMin.Add(rpt1.C1.GetValueOrDefault());
        //    resultMin.Add(rpt1.C2.GetValueOrDefault());
        //    resultMin.Add(rpt1.C3.GetValueOrDefault());
        ...
        //    Serie s2 = new Serie();
        //    s2.Name = "Max";
        //    Rpt_Thing_IOs_Days_Result rpt2 = rpt[1];
        //    List<int> resultMax = new List<int>();
        //    resultMax.Add(rpt2.C1.GetValueOrDefault());
        //    resultMax.Add(rpt2.C2.GetValueOrDefault());
        //    resultMax.Add(rpt2.C3.GetValueOrDefault());
        ...
        //    Serie s3 = new Serie();
        //    s3.Name = "Avg";
        //    Rpt_Thing_IOs_Days_Result rpt3 = rpt[2];
        //    List<int> resultAvg = new List<int>();
        //    resultAvg.Add(rpt3.C1.GetValueOrDefault());
        //    resultAvg.Add(rpt3.C2.GetValueOrDefault());
        //    resultAvg.Add(rpt3.C3.GetValueOrDefault());
        ...
        //public Chart IOs_Hour(long ThingID)
        //{
        //    Thing ep = UnitOfWork_Repositories.repoThings.Find(ThingID);
        //    Chart hc = new Chart();
        //    hc.title.Text = "Thing Hourly Report";
        //    hc.subTitle.Text = ep.Title;
        //    hc.xAxis.GenerateHoursList(true);
        //    hc.legend.layout = Layout.vertical.ToString();

        //    List<Rpt_Thing_IOs_HOURs_Result> rpt = db.Rpt_Thing_IOs_HOURs(ThingID).ToList();

        //    #region GetMin
        //    Serie s1 = new Serie();
        //    s1.Name = "Min";
        //    Rpt_Thing_IOs_HOURs_Result rpt1 = rpt[0];
        //    List<int> resultMin = new List<int>();
        //    resultMin.Add(rpt1.C1.GetValueOrDefault());
        //    resultMin.Add(rpt1.C2.GetValueOrDefault());
        //    resultMin.Add(rpt1.C3.GetValueOrDefault());
        ...
        //    Serie s2 = new Serie();
        //    s2.Name = "Max";
        //    Rpt_Thing_IOs_HOURs_Result rpt2 = rpt[1];
        //    List<int> resultMax = new List<int>();
        //    resultMax.Add(rpt2.C1.GetValueOrDefault());
        //    resultMax.Add(rpt2.C2.GetValueOrDefault());
        //    resultMax.Add(rpt2.C3.GetValueOrDefault());
        ...
        //    Serie s3 = new Serie();
        //    s3.Name = "Avg";
        //    Rpt_Thing_IOs_HOURs_Result rpt3 = rpt[2];
        //    List<int> resultAvg = new List<int>();
        //    resultAvg.Add(rpt3.C1.GetValueOrDefault());
        //    resultAvg.Add(rpt3.C2.GetValueOrDefault());
        //    resultAvg.Add(rpt3.C3.GetValueOrDefault());
