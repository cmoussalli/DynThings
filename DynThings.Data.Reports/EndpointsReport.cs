...
namespace DynThings.Data.Reports
{
    public class EndpointsReport
    {
        ...
        public Chart IOs_Hour(long endPointID)
        {
            ...
            List<Rpt_EndPoint_IOs_HOURs_Result> rpt = db.Rpt_EndPoint_IOs_HOURs(endPointID).ToList();

            #region GetMin
            Serie s1 = new Serie();
            s1.Name = "Min";
            Rpt_EndPoint_IOs_HOURs_Result rpt1 = rpt[0];
            List<int> resultMin = new List<int>();
            resultMin.Add(rpt1.C1.GetValueOrDefault());
            resultMin.Add(rpt1.C2.GetValueOrDefault());
            resultMin.Add(rpt1.C3.GetValueOrDefault());
            ...
            Serie s2 = new Serie();
            s2.Name = "Max";
            Rpt_EndPoint_IOs_HOURs_Result rpt2 = rpt[1];
            List<int> resultMax = new List<int>();
            resultMax.Add(rpt2.C1.GetValueOrDefault());
            resultMax.Add(rpt2.C2.GetValueOrDefault());
            resultMax.Add(rpt2.C3.GetValueOrDefault());
            ...
            Serie s3 = new Serie();
            s3.Name = "Avg";
            Rpt_EndPoint_IOs_HOURs_Result rpt3 = rpt[2];
            List<int> resultAvg = new List<int>();
            resultAvg.Add(rpt3.C1.GetValueOrDefault());
            resultAvg.Add(rpt3.C2.GetValueOrDefault());
            resultAvg.Add(rpt3.C3.GetValueOrDefault());
        ...
        public Chart IOs_Minute(long endPointID)
        {
            ...
            List<Rpt_EndPoint_IOs_Minutes_Result> rpt = db.Rpt_EndPoint_IOs_Minutes(endPointID).ToList();

            #region GetMin
            Serie s1 = new Serie();
            s1.Name = "Min";
            Rpt_EndPoint_IOs_Minutes_Result rpt1 = rpt[0];
            List<int> resultMin = new List<int>();
            resultMin.Add(rpt1.C1.GetValueOrDefault());
            resultMin.Add(rpt1.C2.GetValueOrDefault());
            resultMin.Add(rpt1.C3.GetValueOrDefault());
            ...
            Serie s2 = new Serie();
            s2.Name = "Max";
            Rpt_EndPoint_IOs_Minutes_Result rpt2 = rpt[1];
            List<int> resultMax = new List<int>();
            resultMax.Add(rpt2.C1.GetValueOrDefault());
            resultMax.Add(rpt2.C2.GetValueOrDefault());
            resultMax.Add(rpt2.C3.GetValueOrDefault());
            ...
            Serie s3 = new Serie();
            s3.Name = "Avg";
            Rpt_EndPoint_IOs_Minutes_Result rpt3 = rpt[2];
            List<int> resultAvg = new List<int>();
            resultAvg.Add(rpt3.C1.GetValueOrDefault());
            resultAvg.Add(rpt3.C2.GetValueOrDefault());
            resultAvg.Add(rpt3.C3.GetValueOrDefault());
